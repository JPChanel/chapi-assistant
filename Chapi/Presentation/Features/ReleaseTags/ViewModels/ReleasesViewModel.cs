...
namespace Chapi.Presentation.Features.Releases.ViewModels;
...
public class ReleasesViewModel : ViewModelBase
{
        ...
        INotificationService notificationService) 
    {
        ...
        DeleteTagCommand = new AsyncRelayCommand<object?>(DeleteTagAsync);
        DeployReleaseCommand = new AsyncRelayCommand(DeploySelectedReleaseAsync);
    }
    ...
    public AsyncRelayCommand<object?> DeleteTagCommand { get; }
    ...
    private async Task CreateTagAsync()
    {
        ...
        var logVm = new Chapi.Presentation.Shared.Dialogs.ViewModels.ExecutionLogViewModel();
        logVm.Title = $"Procesando Release {tagName}";
        var view = new Chapi.Presentation.Shared.Dialogs.Views.ExecutionLogDialog { DataContext = logVm };
