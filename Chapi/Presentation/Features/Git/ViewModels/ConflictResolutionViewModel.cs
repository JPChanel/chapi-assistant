...
public class ConflictResolutionViewModel : ViewModelBase
{
        ...
        ResolveConflictUseCase resolveConflictUseCase)
    {
        ...
        AcceptLocalCommand = new AsyncRelayCommand(() => AcceptChangeAsync(true), () => CurrentBlock != null && !CurrentBlock.IsResolved);
        AcceptIncomingCommand = new AsyncRelayCommand(() => AcceptChangeAsync(false), () => CurrentBlock != null && !CurrentBlock.IsResolved);
        ...
        MarkResolvedCommand = new AsyncRelayCommand(SaveResolvedFileAsync, () => SelectedConflict != null && SelectedConflict.IsResolved);
    }
