...
public class ImageConverterService
{
    ...
    /// <summary>
    /// Convierte multiples imagenes a formato WebP
    /// </summary>
    ...
    /// <summary>
    /// Convierte todas las imagenes de una carpeta a formato WebP
    /// </summary>
        ...
        IProgress<int>? percentProgress = null)
    {
        ...
        progress?.Report($"Encontradas {imageFiles.Count} imagenes para convertir");
    ...
    /// <summary>
    /// Obtiene el tamano formateado de un archivo
    /// </summary>
