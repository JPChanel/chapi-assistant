...
public class GitHubOAuthProvider : IGitAuthProvider
{
    ...
    private async Task<string?> ListenForCallbackAsync(string expectedState)
    {
        ...
        string responseString = state == expectedState
            ? "<html><body style='font-family:Arial;text-align:center;padding:50px'><h1 style='color:#28a745'>✅ Autenticación GitHub exitosa</h1><p>Puedes cerrar esta ventana</p></body></html>"
