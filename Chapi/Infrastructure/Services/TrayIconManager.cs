...
namespace Chapi
{
    public class TrayIconManager : IDisposable
    {
        ...
        public TrayIconManager(MainWindow window)
        {
            ...
            {
                Icon = new System.Drawing.Icon("Presentation/Assets/icon.ico"),
        ...
        private ContextMenu CreateContextMenu()
        {
            ...
            contextMenu.Items.Add(CreateMenuItem("Agregar Metodo", PackIconKind.SourceFork, (s, e) => mainWindow.AddMethod_Click()));
        ...
        /// <summary>
        /// Se dispara cuando el usuario hace clic en un proyecto del submenu.
        /// </summary>
        private void ProjectItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Llama al nuevo metodo en MainWindow
